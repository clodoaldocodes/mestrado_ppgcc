...
img_path = "A:\ACOLITE_CLODOALDO\correspondence\LET06652.ARW_stack_q4.png"
results_img = model.predict(source=img_path,
                        conf=0.50,
...
cv2.rectangle(image, (x1, y1), (x2, y2), (0, 255, 0), 2)  # Cor: Verde, Espessura: 2

    # Mostrar a imagem com o retângulo
